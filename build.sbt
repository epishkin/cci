...
organization := "com.epishkin"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/epishkin/cci"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/epishkin/cci"),
    "scm:git:https://github.com/epishkin/cci.git",
    Some("scm:git:git@github.com:epishkin/cci.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("com.epishkin.cci.Main")

mainClass in (Compile, run) := Some("com.epishkin.cci.Main")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("com.epishkin.cci.Main")
